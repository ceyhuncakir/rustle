...
Flow itself is MIT licensed. It downloads or bundles the following, each
...
| [istupakov/parakeet-tdt-0.6b-v3-onnx](https://huggingface.co/istupakov/parakeet-tdt-0.6b-v3-onnx) | CC-BY-4.0 (model), export scripts MIT | The ONNX export Flow loads |
