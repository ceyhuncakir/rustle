...
//!
//! Off unless switched on. When on, Rustle builds two things from the local
...
/// spelling, so a fabricated term becomes a word Rustle will happily insert
...
mod tests {
    ...
    //! Rustle will insert into text the user never said, so the guards matter
