...
//! the fixtures do not cover. (`rustle models` and `rustle dictate` in the app
//! cover downloading, importing and live dictation.)
//!
//! ```text
//! cargo run -p rustle-stt --example stt -- FILE.wav [auto|gpu|cpu]
//! ```
//!
...
use rustle_core::models::DEFAULT_STT_MODEL;
use rustle_stt::Parakeet;
...
fn main() -> anyhow::Result<()> {
    ...
    let id = std::env::var("RUSTLE_STT_MODEL").unwrap_or_else(|_| DEFAULT_STT_MODEL.to_string());
