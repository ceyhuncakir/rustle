//! Live check of the GlobalShortcuts portal: bind Rustle's shortcuts, print
//! what the desktop says and every event that arrives, then let go. The
//! desktop may show its dialog the first time.
//!
//!     cargo run -p rustle-desktop --example portal -- [Ctrl+Alt+Space] [seconds]
...
fn main() -> anyhow::Result<()> {
    ...
    use rustle_core::engine::{Event, Hotkey};
    use rustle_desktop::linux::portal::{self, PortalHotkey};
